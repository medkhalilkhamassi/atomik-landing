...
export type Review = {
    ...
    quote: string;
    imageSrc: string;
    thumbnailSrc?: string; // Made optional to fallback to imageSrc
};
...
export const TestimonialSlider = ({
    ...
    // Simplified logic: just show next 3 in circular buffer
    const thumbnailReviews = [1, 2, 3].map(offset => {
    ...
    return (
        <div
            className={cn(
                "relative w-full min-h-[650px] md:min-h-[600px] overflow-hidden bg-transparent text-foreground p-8 md:p-12",
                className
            )}
        >
                            ...
                            return (
                                ...
                                >
                                    <img
                                        ...
                                        alt={review.name}
                                        className="w-full h-full object-cover object-top" // Ensure thumbnail focuses on top/face
                                    />
                                </button>
                            );
                        })}
                ...
                <div className="md:col-span-4 relative h-80 min-h-[400px] md:min-h-[500px] order-1 md:order-2">
                    <AnimatePresence initial={false} custom={direction}>
                        <motion.img
                            ...
                            className="absolute inset-0 w-full h-full object-cover object-top rounded-lg" // Added object-top for face focus
                        />
                    </AnimatePresence>
                </div>
